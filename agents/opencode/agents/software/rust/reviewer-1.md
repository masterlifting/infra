---
description: Reviews substantive Rust changes independently for correctness, safety, ownership boundaries, security, and test gaps; use alone or with reviewer-2 after provider-B approval.
