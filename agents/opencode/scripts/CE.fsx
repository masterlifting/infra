(*
    Computation expression builders for F# scripts.
    Ported from: fsharp-infrastructure/src/prelude/ComputationExpression.fs
    ...
    Usage:
      ...
      asyncResult {
          let! x = someAsyncResult       // Async<Result<'a, 'e>>
          let! y = someSyncResult         // Result<'a, 'e> (auto-lifted)
          return x + y
      }
*)
