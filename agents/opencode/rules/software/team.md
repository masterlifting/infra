...
- **reviewer**: independently reviews an assigned change with its defined focus area. Reviewers never coordinate with one another or edit code.
...
- When work touches boundaries, dependencies, or architectural constraints, assign all applicable architect agents independently and in parallel; reconcile their guidance yourself.
...
- For code review, assign all applicable reviewer agents independently and in parallel; reconcile their findings yourself.
